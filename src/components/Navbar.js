    ...
    return (
        ...
        <div className="container-fluid">
          ...
          <a class="nav-link" href="/about">About</a>
            ...
            <div className="d-flex">
                <div className="bg-danger rounded mx-1" onClick={()=>{props.toggleMode('danger')}} style={{height: '20px', width:'20px', cursor: 'pointer'}}></div>
            </div>
            <div className="d-flex">
            ...
            <div className="d-flex">
                <div className="bg-light rounded mx-1" onClick={()=>{props.toggleMode('light')}} style={{height: '20px', width:'20px', cursor: 'pointer'}}></div>
            </div>
            <div className="d-flex">
                <div className="bg-dark rounded mx-1" onClick={()=>{props.toggleMode('dark')}} style={{height: '20px', width:'20px', cursor: 'pointer'}}></div>
            </div> */}
